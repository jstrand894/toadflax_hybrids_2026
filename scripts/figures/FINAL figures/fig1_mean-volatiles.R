...
plant_levels <- c("D6", "D6Y6", "Y6", "Y6D6", "RAD", "HBR")
...
compound_labels <- c(
  "cis-b-ocimene"            = "(<i>Z</i>)-\u03b2-<br>ocimene",
  "z-3-hex acetate - 10.46"  = "(<i>Z</i>)-3-hexenyl<br>acetate",
  "caryophyllene - 22.42"    = "\u03b2-<br>caryophyllene",
  "decanal - 16.55"          = "decanal",
  "nonanal - 13.51"          = "nonanal",
  "trans-b-ociemene - 11.42" = "(<i>E</i>)-\u03b2-<br>ocimene",
